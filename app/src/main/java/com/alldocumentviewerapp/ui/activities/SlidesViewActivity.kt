...
import com.alldocumentviewerapp.databinding.ActivitySlidesViewBinding
import com.alldocumentviewerapp.models.TotalFilesModel
import com.alldocumentviewerapp.utils.Utils
import kotlinx.coroutines.joinAll
import kotlinx.coroutines.launch

class SlidesViewActivity : AppCompatActivity() {
    lateinit var binding: ActivitySlidesViewBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_slides_view)
        Utils.statusBarColor(this)
        list= ArrayList()
        list = intent.getParcelableArrayListExtra("slideFilesList")!!
        ...
        lifecycleScope.launch{
            joinAll()
            adapter= SearchDocumentAdapter(list,this@SlidesViewActivity)
            var layoutManager= LinearLayoutManager(this@SlidesViewActivity)
        ...
        binding.searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                adapter = SearchDocumentAdapter(temp, this@SlidesViewActivity)
                binding.recyclerView.adapter = adapter
                return true
            }
        })
