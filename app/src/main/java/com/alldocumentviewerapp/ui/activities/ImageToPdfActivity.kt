...
class ImageToPdfActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding=DataBindingUtil.setContentView(this@ImageToPdfActivity,com.alldocumentviewerapp.R.layout.activity_image_to_pdf)
        ...
        binding.shareImg.setOnClickListener {
            ...
            val fileUri: Uri = FileProvider.getUriForFile(this@ImageToPdfActivity, "com.alldocumentviewerapp.fileprovider", file)
