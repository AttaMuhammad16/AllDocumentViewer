...
import com.easytec.databinding.ActivityDocAndDocxViewBinding
...
@AndroidEntryPoint
class DocAndDocxViewActivity : AppCompatActivity() {
    lateinit var binding: ActivityDocAndDocxViewBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_doc_and_docx_view)
        ...
        lifecycleScope.launch{
            joinAll()
            adapter= SearchDocumentAdapter(list,this@DocAndDocxViewActivity)
            var layoutManager= LinearLayoutManager(this@DocAndDocxViewActivity)
        ...
        binding.searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                adapter = SearchDocumentAdapter(temp, this@DocAndDocxViewActivity)
                binding.recyclerView.adapter = adapter
                return true
            }
        })
