...
import com.easytec.databinding.ActivityAddPdfPasswordBinding
...
class AddPdfPasswordActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shareImg.setOnClickListener {
            val fileUri: Uri = FileProvider.getUriForFile(this@AddPdfPasswordActivity, "com.easytec.fileprovider", newFilePath)
